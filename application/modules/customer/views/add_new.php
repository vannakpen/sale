                    ...
                    <div class="panel-body">
                        <div class="box_margin">
                            <div class="row">
                                ...
                                <input name="cus_first_name" type="text" value="" id="cus_first_name" required="required" class="form-control">
                            </div>
                            <div class="row">
                                <label for="last name"> <?php echo $this->lang->line('tab_cus_last_name'); ?> :</label>
                                <input name="cus_last_name" type="text" value="" id="cus_last_name" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="box_margin">
                            <div class="row">
                                ...
                                <input name="cus_display_name" type="text" value="" id="cus_display_name" class="form-control">
                            </div>
                            <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="box_margin">
                            <div class="row">
                                ...
                                <input name="cus_mobile_1" type="text" value="" id="cus_mobile_1" class="form-control">
                            </div>
                            <div class="row">
                                <label for="mobile 2"> <?php echo $this->lang->line('tab_cus_mobile_2'); ?> :</label>
                                <input name="cus_mobile_2" type="text" value="" id="cus_mobile_1" class="form-control">
                            </div>
                            <div class="row">
                                <label for="address 1"> <?php echo $this->lang->line('tab_cus_address_1'); ?> :</label>
                                <input name="cus_address_1" type="text" value="" id="cus_address_1" class="form-control">
                            </div>
                            <div class="row">
                                <label for="address 2"> <?php echo $this->lang->line('tab_cus_address_2'); ?> :</label>
                                <input name="cus_address_2" type="text" value="" id="cus_address_1" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="box_margin">
                            <div class="row">
                                ...
                                <input name="cus_email" type="text" value="" id="cus_email" class="form-control">
                            </div>
                            <div class="row">
                                <label for="limit order"> <?php echo $this->lang->line('tab_cus_limit_order'); ?> :</label>
                                <input name="cus_limit_order" type="number" value="" id="cus_limit_order" class="form-control">
                            </div>
                            <div class="row">
                                <label for="limit owe amount"> <?php echo $this->lang->line('tab_cus_limit_owe_amount'); ?> :</label>
                                <input name="cus_limit_owe_amount" type="number" step="any" value="" id="cus_limit_owe_amount" class="form-control">
                            </div>
                            <div class="row">
                                <label for="description"> <?php echo $this->lang->line('tab_cus_description'); ?> :</label><br/>
                                <textarea name="cus_description" id="cus_description" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        $('#cus_first_name, #cus_last_name').keyup(function(){
           var $first_name = $('#cus_first_name').val();
           var $last_name = $('#cus_last_name').val();
           $('#cus_display_name').val($first_name + ' ' + $last_name);
        });
